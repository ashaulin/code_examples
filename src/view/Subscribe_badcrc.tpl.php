...
<div id="main">
	<div id="content">
		...
		<p style="text-align:center;"><b>Не верная подпись crc в ссылке.<br />
		Проверьте, что вы верно скопировали ссылку из письма.<br />
		Либо дождитесь следующего и отпишитесь через ссылку из него.</b></p>
		<hr />
		<div id="copyright">
